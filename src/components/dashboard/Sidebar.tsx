"use client";
import { getUnreadCount } from "@/lib/api/inbox";
...
const ADMIN_NAV: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <Icon>
        <path fillRule="evenodd" d="M15.988 3.012A2.25 2.25 0 0 1 18 5.25v6.5A2.25 2.25 0 0 1 15.75 14H13.5v-3.379a3 3 0 0 0-.879-2.121l-3.12-3.121a3 3 0 0 0-1.402-.791A2.252 2.252 0 0 1 10.255 3h5.733ZM10.5 4.75v5a.75.75 0 0 0 .75.75h5a.75.75 0 0 0 0-1.5H12V4.75a.75.75 0 0 0-1.5 0Z" clipRule="evenodd" />
        <path d="M2 6a2 2 0 0 1 2-2h1a.75.75 0 0 1 0 1.5H4a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5v-2.5a.75.75 0 0 1 1.5 0V16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Z" />
      </Icon>
    ),
  },
  {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex h-16 items-center border-b border-gray-100 px-5">
        <Link href="/home" className="flex items-center gap-2" onClick={onNavClick}>
