  ...
  return (
    <div className="space-y-2">
      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-gray-100">
        <Image src={allImages[active].image} alt={title} fill className="object-cover" priority />
        {allImages.length > 1 && (
          <>
            <button
              type="button"
...
export function ListingDetailView({ id, backHref, backLabel }: Props) {
  ...
  if (notFound) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <BackButton href={backHref} label={backLabel} className="mt-4" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      <BackButton href={backHref} label={backLabel} className="-ml-1" />
