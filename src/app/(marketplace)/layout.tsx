...
const CATEGORIES = ["All", "Electronics", "Vehicles", "Property", "Services", "Fashion", "Agriculture", "Hardware", "Mining Equipment", "Printing & Machinery", "Transportation", "Catering", "Schools"];
      ...
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-6 flex gap-6 flex-1">
        ...
        <aside className="hidden lg:block w-52 shrink-0">
          ...
          <nav className="space-y-0.5 text-sm font-medium text-gray-600">
            ...
            {CATEGORIES.filter(c => c !== "Schools").map((cat) => (
              <a
                key={cat}
