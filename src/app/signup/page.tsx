    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur-lg">
        <div className="px-8 py-10">
          ...
          <p className="mt-2 text-sm text-slate-600">Sign up to start buying and selling.</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-600">
            ...
            <a href="/login" className="font-medium text-brand-600 hover:text-brand-700">Log in</a>
          </p>
        </div>
      </div>
    </div>
